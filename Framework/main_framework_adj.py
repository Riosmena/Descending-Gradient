...
algorithm using the gradient descent method, with regularization
using a framework. The dataset used is the 'imports-85.data' file, 
which contains information about cars and their prices. The goal 
is to predict the price of a car based on its features.

==========================================================================
Date                    Author                   Description
02/09/2024         J. Riosmena          First implementation
02/09/2024         J. Riosmena          Added regularization
...
if __name__ == "__main__":
    ...
    # Define initial values for epochs, learning rate, and regularization
    epochs = 1000
    learning_rate = 0.03
    alpha = 0.00001

    # Train the model using scikit-learn's SGDRegressor with L2 regularization
